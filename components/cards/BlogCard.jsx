...
export default function BlogCard(props) {
  return (
    <>
      <div className="flex gap-7 overflow-scroll pb-4 p-1.2813 py-8 md:pl-2.25   lg:pl-3.65 lg-sm:pb-10 cardScroll">
        <div class="flex flex-col  md:w-112 lg:w-29.8125 box-border px-5 w-75.5 rounded-xl border border-solid border-secondaryGrey shadow-2.5xl lg:px-35">
          <div class="flex-1 bg-white flex flex-col justify-between">
            <div class="flex-1">
              <p class="w-65.5 mt-1.25 font-Neufile text-desktopHeadingTwo font-normal leading-2.5 tracking-cardDescription text-primaryGrey md:w-102 lg:w-27.3125
        ">
          ...
          ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto accusantium praesentium eius, ut atque fuga culpa, similique sequi cum eos quis dolorum.</p>
            ...
            <div class="mt-1.6875 xl:mt-2.5625 mb-0.625 space-y-0.5">
        ...
        ">
              ...
              <a href="#" class="block mt-2">
                <p class="
          w-65.5 font-Neufile text-mobHeadingThree font-normal leading-8.5 tracking-cardDescription text-black md:w-109.25  md:text-4xl md:leading-10.5 tablet:text-tabletHeadingOne tablet:leading-2.6 lg:text-tabletHeadingOne lg:leading-2.625 mt-1.5 ">Launch of the Africa DeFi Alliance DAO</p>
                <p class="mt-3  w-65.5 font-Neufile text-xl font-normal tracking-cardSubTitle text-black  md:w-101.25 md:text-2xl md:tracking-cardSubDescription lg:w-27.3125
          ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto accusantium praesentium eius, ut atque fuga culpa, similique sequi cum eos quis dolorum.</p>
              </a>
            </div>
