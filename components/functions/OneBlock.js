...
export function OneBlock({
    ...
    return (
      <div className='flex flex-col'>
        <div
          onClick={() => expand()}
          className={`flex w-full cursor-pointer justify-between border-b-[1px] ${isOpened ? 'border-primary-purple' : 'border-solid-black'} `}
        >
          <h2 className={`${
        ...
        <p
          className={`${
            isOpened ? 'h-max opacity-100' : 'h-[0px] opacity-0'
